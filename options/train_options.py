...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--niter', type=int, default=25, help='total epoches')
        parser.add_argument('--beta1', type=float, default=0.9, help='momentum term of adam')
        parser.add_argument('--lr', type=float, default=0.0004, help='initial learning rate for adam')

        parser.add_argument('--ratio_sampling', action='store_true', help='if specified, use ratio sampling to control real/fake ratio')
        parser.add_argument('--real_ratio', type=float, default=0.95, help='ratio of real images to select from training set (default: 0.9)')
        parser.add_argument('--fake_ratio', type=float, default=0.05, help='ratio of fake images to select from training set (default: 0.1)')
