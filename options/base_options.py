...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--wang2020_data_path', default='/opt/data/private/ysb/NPR-DeepfakeDetection/Few-Shot-AIGI-Detector-main/data/imagenet_ai_0419_sdv4', help='only used if data_mode==wang2020 it should contain train and test folders')
        ...
        parser.add_argument('--name', type=str, default='sdim_95:5', help='name of the experiment. It decides where to store samples and models')
